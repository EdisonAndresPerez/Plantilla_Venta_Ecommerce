...
export const CustomPromotion = () => {
  return (
    <section className="py-20 px-4 lg:px-8 mt-16">
      <div className="container mx-auto">
        <div
          className="relative overflow-hidden rounded-3xl p-12 lg:p-20 text-center bg-gradient-to-r from-purple-600 via-pink-500 to-red-500"
        >
          {/* Decorative circles */}
          <div className="absolute top-0 right-0 h-64 w-64 rounded-full bg-white/10 -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-0 h-48 w-48 rounded-full bg-white/10 translate-y-1/2 -translate-x-1/2" />

          <div className="relative z-10">
            <Sparkles className="h-12 w-12 text-white/80 mx-auto mb-6 animate-float" />
